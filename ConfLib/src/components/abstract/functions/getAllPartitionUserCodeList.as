package components.abstract.functions
{
	...
	public function getAllPartitionUserCodeList(bit:int, onlyexisting:Boolean=false):Array
	{	// для приборов, где все разделы есть всегда
		...
		if(  DS.isfam( DS.K5,  DS.K5, DS.K53G, DS.K5AA, DS.A_BRD  ) ) list = truncateList( list );
