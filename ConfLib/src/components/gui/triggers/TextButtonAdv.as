package components.gui.triggers
{
	...
	public class TextButtonAdv extends UIComponent implements IFocusable
	{
		...
		public function setUp( _name:String, _clickFunc:Function, _value:Object=null ):void 
		{
			setName( _name );
			value = _value;
			fClick = _clickFunc;
