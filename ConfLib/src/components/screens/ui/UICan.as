package components.screens.ui
{
	...
	//		FLAG_SAVABLE = true;
		...
		//	globalY = anchor;
			...
			starterCMD = [CMD.CAN_CAR_ID, CMD.CAN_INPUTS, CMD.CAN_PARAMS_FUEL, CMD.CAN_PARAMS_ENGINE, CMD.HISTORY_AVAILABLE_PAR, CMD.HISTORY_SELECT_PAR, CMD.CAN_PARAMS_EXPL];
		}
