package components.screens.ui
{
	...
	import components.screens.opt.OptIMBKey;
	import components.static.CMD;
	import components.static.RF_FUNCT;
	import components.system.SavePerformer;

	public class UIIMBKeys extends UIRadioDeviceRoot
	{
		...
		public function UIIMBKeys()
		{
			...
			DEVICE_MAX = OPERATOR.getSchema( CMD.VR_TM_KEY).StructCount;
			fwidth = 432;
			fheight = 140;
			...
			///TODO: не предпологается использовать в версии для иммобилайзера
			bRestoreDevice.parent.removeChild( bRestoreDevice );
