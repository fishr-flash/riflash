package components.screens.ui
{
	...
	public class UIServerCoordUNI_bak extends UI_BaseComponent
	{
		...
		public function UIServerCoordUNI_bak()
		{
			super();
			...
			if ( DS.isNoEGTSVojagers( DS.alias )) {
		...
		private function onRITM(t:IFormString=null):void
		{
			...
			if( DS.isNoEGTSVojagers( DS.alias ) )go.movey("egts", b==true ? 326:66);
...
class OptAuthorization extends OptionsBlock
{
	public function OptAuthorization(str:int)
	{
		...
		structureID = str;
		addui( new FSSimple, operatingCMD, str == 1 ? loc("g_username") : loc("g_password"), null, 1, null, "A-z0-9", 31 );
