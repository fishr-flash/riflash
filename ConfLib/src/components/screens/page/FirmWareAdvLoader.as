package components.screens.page
{
	...
	public class FirmWareAdvLoader extends UIComponent implements IServiceFrame
	{
		...
		protected var TOP_SHIFT:int = 20;
		...
		protected var tDeviceName:FSSimple;
		protected var tObject:FSSimple;
		protected var tObjectEgts:FSSimple;
/**		protected var tMasterCode:FSSimple;		RELEASE 28+ */
		...
		protected var bot:HeightBot;
		protected var group:GroupOperator;	

		protected var structCounter:int = 0;
		
		public function FirmWareAdvLoader(lbl:String="")
		{
