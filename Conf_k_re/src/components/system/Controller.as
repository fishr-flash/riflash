package components.system
{
	...
	public class Controller implements ISaveController
	{
		...
		public static var hook:Function;	// запрещает кнопке сохранить собственно отправлять сигнал на сохранение
 ...
 * ******************************************************************/		
		...
		public function isSaveButtonActive():Boolean
		{
 ...
 * 		Energy Modes
 * ******************************************************************/
		public function getEventList(checkList:Array):Array
		{
			var list:Array = new Array;
			list.push( {"labeldata":1, "label":"при нажатии кнопки", "data": checkList[0]} );
			list.push( {"labeldata":2, "label":"при установке блока \"Контейнер\"", "data":checkList[1]} );
			list.push( {"labeldata":3, "label":"при снятии блока \"Контейнер\"", "data":checkList[2]} );
