package components.screens.opt
{
	...
	public class OptLinkChannelK1M extends OptionsBlock
	{
		...
		public function OptLinkChannelK1M(struct:int)
		{
			super();
			...
			switch(DS.alias) {
				case DS.isfam( DS.K5 ):
					comLink = [
						...
						{label:loc("ui_linkch_cid_pulse"),data:1536},// 8й бит симкарты должен быть 0
