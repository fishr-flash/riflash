package foundation
{
	...
	import components.gui.PopUpFinalize;
	...
	public class Founder extends Application implements IFounder
	{
		...
		private function addedToStage(ev:Event):void
		{
			...
			ui.addChild( PopUpFinalize.access() );
...
/***************************** EVENTS				*/
		...
		private function onKeyDown(ev:KeyboardEvent):void
		{
			...
			else if ( ev.altKey && ev.ctrlKey && ev.keyCode == KEYS.Key_D) 
				PopUpFinalize.access().open();
			else if ( ev.altKey && ev.ctrlKey && ev.keyCode == KEYS.Key_P)
				PopUpFinalize.access().open();
