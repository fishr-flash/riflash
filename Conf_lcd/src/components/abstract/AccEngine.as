package components.abstract
{
	...
	public class AccEngine
	{
		...
		public static const REQUEST_DELAY:int = 100;	// в милисекундах
...
/** высчитывание сильнейшего удара */		
		private static var highestValue:HighestStrikeValue;
		public static function getHighestValue(n:Number):Number
		{
			if(!highestValue)
				highestValue = new HighestStrikeValue;
			return highestValue.getValue(n);
		}
...
class HighestStrikeValue
{
	private var value:Number=0;
	private var timer:Timer;
	
	public function getValue(n:Number):Number
	{
		if (!timer) {
			timer = new Timer(500);
