	...
	public class Utility
	{
		...
		public static function formateNumbersToLetters( _number:int):String {
			...
			if ( stringNumber.length > 5 )
				return stringNumber.substring( 0, stringNumber.length-5 ) + " м";
			else if ( stringNumber.length > 3 ) {
				if ( stringNumber.length == 4 )
					return stringNumber.charAt(0)+","+stringNumber.charAt(1) + " к";
				else
					return stringNumber.substring( 0, stringNumber.length-3 ) + " к";
