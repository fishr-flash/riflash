package components.screens.ui
{
	...
	public class UIEnergyModeV4 extends UI_BaseComponent
	{
		...
		public function UIEnergyModeV4()
		{
			super();
			...
			opts[11].addEventListener( Event.CHANGE, onChange );
			opts[12].addEventListener( Event.CHANGE, onChange );
			addChild( opts[12] );
