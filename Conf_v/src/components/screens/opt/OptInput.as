package components.screens.opt
{
	...
	public class OptInput extends OptionsBlock
	{
		private const fullmenu:Array = [
			{data:0,label:loc("input_m_disabled")},
			{data:1,label:loc("input_m_discrete")},
			{data:2,label:loc("input_m_analog")},
			{data:3,label:loc("input_m_frequency")},
			{data:4,label:loc("input_m_pulse")}
		];
		private var input_digital:Array;
		private const input_default:Array = UTIL.getComboBoxList([[0,loc("input_fuel_sensor")],[1,loc("input_temp_sensor")]]);
		private const input_pulse:Array = UTIL.getComboBoxList([[0,loc("input_measure_fuel_spend")],[1,loc("input_temp_sensor")]]);
		...
		public function OptInput(s:int)
		{
			...
			if( DS.isDevice( DS.V_ASN ) )
				input_digital = UTIL.getComboBoxList([[0,loc("input_mecha")],[1,loc("input_ignition")],[2,loc("input_panic_button")],[6,loc("voice_call_dispatcher")]]);
			else
				input_digital = UTIL.getComboBoxList([[0,loc("input_mecha")],[1,loc("input_ignition")],[2,loc("input_panic_button")]]);
			
			attuneElement(250, 270 );
				
			createUIElement( new FSShadow, CMD.VR_INPUT_TYPE, "", null, 1 );
			createUIElement( new FSComboBox, CMD.VR_INPUT_TYPE, loc("input_type"), load, 2, getMenu(0) );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			...
			createUIElement( new FSComboBox, CMD.VR_INPUT_DIGITAL, loc("input_purpose"), onInputDigital, 2);
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_DISCRED.toString(), getLastElement() );
			createUIElement( new FSComboBox, CMD.VR_INPUT_DIGITAL, loc("input_signal_polarity"), null, 3, UTIL.getComboBoxList([[0,loc("input_positive_pol")],[1,loc("input_nagative_pol")]]) );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_DISCRED.toString(), getLastElement() );
			createUIElement( new FSComboBox, CMD.VR_INPUT_DIGITAL, loc("input_time_signal_trigger"), null, 4, 
			...
			createUIElement( new FormString, 0, loc("input_signal_ignition"),
				null,1);
			...
			createUIElement( new FSComboBox, CMD.VR_INPUT_ANALOG, loc("input_purpose"), null, 2 );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_ANALOG.toString(), getLastElement() );
			createUIElement( new FSComboBox, CMD.VR_INPUT_ANALOG, loc("input_measure_fuel_level"), null, 3, UTIL.getComboBoxList([[0,loc("input_constant")],[1,loc("input_ignition_working")]]) );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_ANALOG.toString(), getLastElement() );
			group.add( TYPE_ANALOG.toString(), drawSeparator(520) );
	
			addui( new FSSimple, CMD.VR_INPUT_ANALOG_VALUE, loc("input_insta_input_value"), null, 1 );
			attuneElement( 300+159, 60, FSSimple.F_CELL_NOTSELECTABLE);
			group.add( TYPE_ANALOG.toString(), getLastElement() );
			addui( new FSSimple, CMD.VR_INPUT_ANALOG_VALUE, loc("input_average_input_value"), null, 2 );
			attuneElement( 300+159, 60, FSSimple.F_CELL_NOTSELECTABLE );
			group.add( TYPE_ANALOG.toString(), getLastElement() );
			...
			createUIElement( new FSComboBox, CMD.VR_INPUT_FREQ, loc("input_purpose"), null, 2 );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_FREQ.toString(), getLastElement() );
			createUIElement( new FSComboBox, CMD.VR_INPUT_FREQ, loc("input_measure_fuel_level"), null, 3, UTIL.getComboBoxList([[0,loc("input_constant")],[1,loc("input_ignition_working")]]) );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_FREQ.toString(), getLastElement() );
			...
			createUIElement( new FSComboBox, CMD.VR_INPUT_PULSE, loc("input_purpose"), null, 2 );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_PULSE.toString(), getLastElement() );
			createUIElement( new FSComboBox, CMD.VR_INPUT_PULSE, loc("input_measure_fuel_spend"), null, 3, UTIL.getComboBoxList([[0,loc("input_input_dvs")],[1,loc("input_output_dvs")]]) );
			attuneElement(250, 270, FSComboBox.F_COMBOBOX_NOTEDITABLE );
			group.add( TYPE_PULSE.toString(), getLastElement() );
		}
