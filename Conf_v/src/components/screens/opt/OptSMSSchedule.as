package components.screens.opt
{
	...
	public class OptSMSSchedule extends OptionsBlock
	{
		private var cshift:int;
		private var _disabled:Boolean;
		
		public function OptSMSSchedule(label:String,s:int, shift:int, fshift:int, a:IDataAdapter=null)
		{
			super();
			operatingCMD = CMD.VR_SMS_SCHEDULE;
			structureID = s;
...
//			FLAG_SAVABLE = false;
		...
		override public function putRawData(a:Array):void
		{
			...
			if ( adapted[ 7 ] + VoyagerBot.TIME_ZONE< 0) {
				day = adapted[0];
				adapted.splice( 0,1);
				adapted.splice(6,0,day);
				
			} else if ( adapted[ 7 ]  + VoyagerBot.TIME_ZONE > 23) {
				day = adapted[6];
				adapted.splice( 6,1);
		...
		public function adaptTimeZone(value:Object):void
		{
			...
			var t:Object = value.data[ operatingCMD ][getStructure()];
			var a:Array = []; 
