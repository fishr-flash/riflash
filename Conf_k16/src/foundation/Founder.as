package foundation
{
	...
	import foundation.functions.createMenu;
	...
	public class Founder extends Application implements IFounder
	{
		...
		private function addedToStage(e:Event):void
		{
			...
			ui.graphics.beginFill( COLOR.NAVI_MENU_LIGHT_BLUE_BG );
		...
		//	MISC.COPY_LEVEL = CONST.LEVEL;
			MISC.COPY_TARGET_SOFTWARE = CONST.RELEASE;
		...
		//	console = new DevConsole;
			...
			loader = new LoaderServant(initMenuSelection, defaultMenu, createMenu);
			addLabels( ui );
			
			SharedObjectBot.register(MISC.COPY_VER + CONST.SAVE_PATH);
			...
			savebutton.setName(loc("sys_save"));
...
//					}
			...
			if (notExist) {
				setPageLabel( loc("sys_page_not_exist") );
				PAGE_READY = true;
				screenBlock.visible = false;
				navi.isReady = true;
				cmdSwitch = -1;
