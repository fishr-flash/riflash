package components.screens.opt
{
	...
	public class OptInput extends OptionsBlock
	{
		...
		private const input_digital:Array = UTIL.getComboBoxList([[0,loc("input_mecha")],[1,loc("input_ignition")],[2,loc("input_panic_button")]]);
		...
		public function OptInput(s:int)
		{
			...
			attuneElement(300, 220, FSComboBox.F_COMBOBOX_NOTEDITABLE );*/
			createUIElement( new FSShadow, CMD.VR_INPUT_DIGITAL, "", null, 3 );
			group.add( TYPE_DISCRED.toString(), getLastElement() );
			
			createUIElement( new FSComboBox, CMD.VR_INPUT_DIGITAL, loc("input_time_signal_trigger"), doSaveTimeSignal, 4, 
		...
		override public function putRawData(a:Array):void
		{
			...
			distribute( data, CMD.VR_INPUT_DIGITAL );
			load(f,false);
		}
		...
		private function doSaveTimeSignal( ifr:IFormString ):void
		{
			remember( ifr );
